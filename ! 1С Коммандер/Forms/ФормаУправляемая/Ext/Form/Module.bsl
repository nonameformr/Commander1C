...
Процедура ПоказатьРазмерДискаНаКлиенте(ИмяЭлементаДиска, ИмяЭлементаНадписи)
	...
	Если СистемнаяИнформация.ТипПлатформы = ТипПлатформы.Windows_x86
		...
		#Иначе
			РазмерДискаВиндовсКлиент(ИмяЭлементаДиска, ИмяЭлементаНадписи);
		#КонецЕсли
	Иначе
...
Процедура ПоказатьРазмерДискаНаСервере(ИмяЭлементаДиска, ИмяЭлементаНадписи)
	...
	Если СистемнаяИнформация.ТипПлатформы = ТипПлатформы.Windows_x86 
		...
		РазмерДискаВиндовсСервер(ИмяЭлементаДиска, ИмяЭлементаНадписи);
	Иначе
...
&НаКлиенте
Процедура РазмерДискаВиндовсКлиент(ИмяЭлементаДиска, ИмяЭлементаНадписи)
...
&НаСервере
Процедура РазмерДискаВиндовсСервер(ИмяЭлементаДиска, ИмяЭлементаНадписи)
